...
const Card:React.FC<CardProps> = ({skillImage, skillTitle,bgCoustomeColor}) =>{
  ...
  return (
    <div>
         <div className={`text-center p-4 border-[0] rounded-lg shadow-md ${(bgCoustomeColor != undefined|| bgCoustomeColor==='' )? bgCoustomeColor :"bg-white"} flex flex-col justify-center items-center mt-8`}>
